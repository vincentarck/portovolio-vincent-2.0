...
export default function AlertCompanyInfo({ msg, link, setInfoCompany }: Props) {
  return (
    <div
      className="bg-slate-200 border-t-4 border-gray-500 rounded-b text-teal-900 px-4 pt-3 shadow-md absolute top-[55%] left-[90%] z-10 w-56 h-56 overflow-scroll scrollbar-none"
      role="alert"
